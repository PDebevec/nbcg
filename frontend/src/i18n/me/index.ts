  ...
  admin: {
    ...
    history: {
      ...
      fields: {
        ...
        cobissId: 'COBISS ID',
        summaryNote: 'Sažetak',
        targetAudienceNote: 'Ciljna publika',
        notes: 'Napomene',
        ...
        seriesTitle: 'Serija',
        seriesIssn: 'ISSN serije',
        seriesVolume: 'Sveska serije',
        uniformTitle: 'Jedinstveni naslov',
        originalTitle: 'Izvorni naslov',
        udc: 'UDK',
        subjects: 'Predmetne odrednice',
        geographicSubjects: 'Geografske odrednice',
        keywords: 'Ključne riječi',
        authors: 'Autor',
        corporateAuthors: 'Korporativni autor',
        familyName: 'Prezime',
        firstName: 'Ime',
        name: 'Naziv',
        role: 'Uloga',
