...
ALTER TABLE "drafts"  ADD COLUMN "version" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "records" ADD COLUMN "version" INTEGER NOT NULL DEFAULT 0;

-- Update the children-count trigger to also bump the parent's version
-- when it mutates the parent's metadata.
